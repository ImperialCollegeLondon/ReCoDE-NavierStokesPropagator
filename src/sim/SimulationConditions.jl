...
"""
BoundTuple is the type for the velocity boundary condition key (bound_cond::Dict) of the upper and lower wall.
...
"""
SimulationCondition contains all required information that describes 
    the metadata of the simulation that is unrelated to the domain (DomainDescriptors) 
    or state (State) of the simulation.
"""
